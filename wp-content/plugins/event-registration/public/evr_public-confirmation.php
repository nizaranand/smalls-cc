...
<br /><div style="float:left;"><input type="button" value=" Make a Change " onclick="history.go(-1);return false;" /></div>
...
<input type="submit" name="mySubmit" id="mySubmit" value="<?php _e('Proceed to Checkout','evr_language');?>" /> 
