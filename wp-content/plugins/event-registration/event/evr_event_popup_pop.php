...
<div id="popup<?php echo $event_id;?>" class="popup_block">
    ...
    <table class="evr_evntpop">
						...
						<input type="button" onClick="location.href='<?php echo evr_permalink($company_options['evr_page_id']);?>action=evregister&event_id=<?php echo $event_id;?>'" value='Pay with Credit Card'/> 
