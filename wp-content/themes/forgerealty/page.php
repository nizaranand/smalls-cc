...
?>
	...
	<?php if(!is_front_page() && !is_blog_page()):?>
		<div class="head_text">
		 <h2>
<?php the_title();
/* jonathan@smalls.cc   2012 June 6
Client wants a contact button on every page, so here it is in the title DIV.
*/
?>
         <a href  =  'http://forgerealty.smalls.cc/?page_id=26'   >
         <span   class =  smalls-contact >  Contact Us Today  </span>   </a>
      </h2>
      </div><!-- / page title -->  
	<?php endif;?>
