...
function	TableNames()
{	$tblCommentMeta		=	$wpdb -> prefix	.	'commentmeta';
	$tblComments		=	$wpdb -> prefix	.	'comments';
	$tblLinks		=	$wpdb -> prefix	.	'links';
	$tblOptions		=	$wpdb -> prefix	.	'options';
	$tblPostMeta		=	$wpdb -> prefix	.	'postmeta';
	$tblPosts		=	$wpdb -> prefix	.	'posts'
	$tblTerms		=	$wpdb -> prefix	.	'terms';
	$tblRelationships	=	$wpdb -> prefix	.	'relationships';
	$tblTaxonomy		=	$wpdb -> prefix	.	'taxonomy';
	$tblUserMeta		=	$wpdb -> prefix	.	'usermeta';
