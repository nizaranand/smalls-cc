...
<meta name="google-site-verification" content="WyxDWvz1WQ9sByWRAHk1XTQsXCbiQbNJP0IkxRc954A" />
</head>
...
I removed this shopping cart header, because I use Google Checkout
rather than the poorly documented WP E-Commerce cart.
...
I reprogrammed the front page header image, because there was no
guarantee that the selected entry would have an image associated
with it. I also wanted more control over what items were featured
without having to make separate entries in the WP_POSTS table to
achieve that.
