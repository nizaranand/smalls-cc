...
<h2 class="review-order"><?php echo __('Please review your order', 'wpsc'); ?></h2>
<table class="productcart">
		...
		<tr class="product_row">
			...
			<td>
				<form action="<?php echo get_option('shopping_cart_url'); ?>" method="post" class="adjustform">
					...
					<input type="submit" value="<?php echo __('Update', 'wpsc'); ?>" name="submit" class="regular-button" />
				</form>
			</td>
			<?php if(wpsc_uses_shipping()): ?>
	...
	<?php if(wpsc_uses_shipping()  && wpsc_has_shipping_form()): ?>
		<h3><?php echo __('Calculate Shipping Price', 'wpsc'); ?></h3>
	...
	<a href="#checkout-step-2" id="checkout-next">Next</a>
</div>
	...
	<h2 class="checking-out"><?php echo __('Ready To Check Out?', 'wpsc'); ?></h2>
	<?php/* echo __('Note, Once you press submit, you will need to have your Credit card handy.', 'wpsc'); <br /> */?>
	<p class="required"><?php echo __('Fields marked with an asterisk must be filled in.', 'wpsc'); ?></p>
	<?php
	...
	<a href="#checkout-step-1" id="checkout-back">Back</a>
</div>
<?php
else:
